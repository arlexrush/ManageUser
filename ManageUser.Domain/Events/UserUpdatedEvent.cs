namespace ManageUser.Domain.Events
{
    public class UserUpdatedEvent : IDomainEvent
    {
        ...
        public Type EventType { get; } = typeof(UserUpdatedEvent);

        public Guid EventId { get; } = Guid.NewGuid();

        public string EventName { get; } = nameof(UserUpdatedEvent);
        ...
        public UserUpdatedEvent(string userId, string email, object? data)
        {
            UserId = userId;
            Email = email;
            Data = data;
